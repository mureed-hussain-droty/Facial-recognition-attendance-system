...
window.title("MA Attendance System")
...
# Create a function to open the main GUI
def open_main_gui():
    welcome_window.destroy()  # Close the welcome window
    # Replace this with your code to open the main GUI (your existing code)

# Create the welcome window
welcome_window = tk.Tk()
welcome_window.geometry("1280x720")
welcome_window.title("Welcome to Attendance System")

# Create a label with a welcome message
welcome_label = tk.Label(welcome_window, text="Welcome to GB Attendance System", font=('times', 16, 'bold'))
welcome_label.pack(pady=20)

# Create a "Menu" button that opens the main GUI
menu_button = tk.Button(welcome_window, text="let starts", command=open_main_gui, fg="white", bg="green", font=('times', 14, 'bold'))
menu_button.pack()
